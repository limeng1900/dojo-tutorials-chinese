原文地址：https://dojotoolkit.org/documentation/tutorials/1.10/creating\_stores/index.html
...
下一步：使用\`dojo/store/Observable\`和一些store来处理通知事件，还有\[使用 Dojo Store API 处理实时数据\]\(https://dojotoolkit.org/documentation/tutorials/1.10/realtime\_stores\)。
